...
let productContainer1 = document.querySelector(".product");
    //console.log(productContainer1.id);
    if (productContainer1) {
        ...
        .then(data => {
            ...
            data.products.forEach(function(product) {
                if (product.id == productContainer1.id) {
                    console.log(product.id);
                    html += 
                    `
                    <div class="product-picture">
                        <img class="picture-js" src="${product.img}" alt="iPhone 12">
                    ...
                    productBox.insertAdjacentHTML("afterbegin", html);
                    productInfo.insertAdjacentHTML("afterbegin", html1);
                    productInfo.insertAdjacentHTML("beforeend", html2);
